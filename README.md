...
- 선형 회귀 방식 이용
  ...
  - 업데이트
    ...
    - 분산
      ...
      - $\Sigma_{t}$는 $(X^TX + \Lambda_{0})^-1$![스크린샷 2020-10-29 오후 5.37.31](/Users/admin/Library/Application Support/typora-user-images/스크린샷 2020-10-29 오후 5.37.31.png)
      - $\a_{t}$는 $a_{0} + t/2$로 업데이트, $\b_{t}$는 $b_{0} + 1/2(Y^{T}Y+\mu^{T}_{0}\Sigma_{0}\mu_{0} -\mu_{t}^{T}\Sigma_{t}^{-1}\mu_{t})$

      ![스크린샷 2020-10-29 오후 5.34.19](/Users/admin/Library/Application Support/typora-user-images/스크린샷 2020-10-29 오후 5.34.19.png)![스크린샷 2020-10-29 오후 5.35.14](/Users/admin/Library/Application Support/typora-user-images/스크린샷 2020-10-29 오후 5.35.14.png)
