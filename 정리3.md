...
- 선형 회귀 방식 이용
  ...
  - 업데이트
    ...
    - 분산
      ...
      - $\Sigma_{t}$는 $(X^TX + \Lambda_{0})^-1$![스크린샷 2020-10-29 오후 5.37.31](/Users/admin/Library/Application Support/typora-user-images/스크린샷 2020-10-29 오후 5.37.31.png)
